...
emailField = document.getElementById("emailInputRegister");
passwordField = document.getElementById("passwordInputRegister");
...
const formAlert = (e) => {
  ...
  resetAlert(passwordField);
	if (passwordField.value.length < 8) {
		invalidAlert(passwordField, "Come on, at least 8 characters please!");
		return;
	}
